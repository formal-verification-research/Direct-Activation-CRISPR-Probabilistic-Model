using CSV,ProgressMeter,Tables, ArgParse,Base.Threads,DataFrames,OrdinaryDiffEq,SteadyStateDiffEq,Catalyst, Latexify
let
...
# Species:
sps = @species G_d(t) = 9.0 md(t) d(t) S_Ap(t) g_Ap(t) S_An(t) g_An(t) c_Ap(t) c_An(t) D_A(t) = 40.0 C_Ap(t) C_An(t) C_Ap_An(t) g_Bp(t) c_Bp(t) g_Bn(t) c_Bn(t) D_B(t) = 40.0 C_Bp(t) C_Bn(t) C_Bp_Bn(t) g_Cp(t) c_Cp(t) g_Cn(t) c_Cn(t) D_C(t) = 40.0 C_Cp(t) C_Cn(t) C_Cp_Cn(t) m_C(t) Y_C(t)
...
rn=@reaction_network rn begin
    ...
    @species G_d(t) = 9.0 md(t) = 0.0 d(t) = 0.0 S_A(t) = 40.0 g_Ap(t) = 0.0 g_An(t) = 0.0 c_Ap(t) = 0.0 c_An(t) = 0.0 D_A(t) = 40.0 C_Ap(t) = 0.0 C_An(t) = 0.0 C_Ap_An(t) = 0.0 g_Bp(t) = 0.0 c_Bp(t) = 0.0 g_Bn(t) = 0.0 c_Bn(t) = 0.0 D_B(t) = 40.0 C_Bp(t) = 0.0 C_Bn(t) = 0.0 C_Bp_Bn(t) = 0.0 g_Cp(t) = 0.0 c_Cp(t) = 0.0 g_Cn(t) = 0.0 c_Cn(t) = 0.0 D_C(t) = 40.0 C_Cp(t) = 0.0 C_Cn(t) = 0.0 C_Cp_Cn(t) = 0.0 m_C(t) = 0.0 Y_C(t) = 0.0 C_B_Bp(t) = 0.0 C_B_Bn(t) = 0.0 C_B_Bp_Bn(t) = 0.0 C_A_Ap(t) = 0.0 C_A_An(t) = 0.0 C_A_Ap_An(t) = 0.0 C_C_Cp(t) = 0.0 C_C_Cn(t) = 0.0 C_C_Cp_Cn(t) = 0.0 
    dtet(I_d), G_d --> md + G_d
    3.59, md --> d + md
    γ_p, d --> ∅
    γ_m, md --> ∅
